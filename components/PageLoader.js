    ...
    <AnimatePresence>
      {loading && (
        <motion.div
          ...
          className="fixed inset-0 z-[999] flex items-center justify-center bg-[#05071a]"
        >
          <div className="relative flex flex-col items-center gap-6">
            ...
            >
              ...
              <motion.div
                className="absolute -inset-3 rounded-full border border-[#6B5CFF]/40"
            ...
            <motion.div className="w-32 h-[2px] rounded-full bg-white/[0.06] overflow-hidden">
              <motion.div
                className="h-full rounded-full bg-gradient-to-r from-[#2E7BFF] via-[#6B5CFF] to-[#FF4FD8]"
                initial={{ x: "-100%" }}
                animate={{ x: "0%" }}
          ...
          <motion.div
            ...
            className="absolute inset-0 origin-left bg-[#05071a]"
          />
        </motion.div>
      )}
    </AnimatePresence>
