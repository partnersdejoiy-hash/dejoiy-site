...
components/
  ...
  HeroSection.js        # Hero with CSS orb animations
  ...
  ServiceCard.js        # Service card with glass effect
  IndustryGrid.js       # Industry cards grid
  EmployeeGrid.js       # Team photo cards
  ...
  ButtonGlow.js         # CTA button component
  PageTransition.js     # Framer Motion page transitions
  SmoothCursor.js       # Custom cursor effect
